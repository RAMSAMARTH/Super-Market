			   ...
			   <!-- Collect the nav links, forms, and other content for toggling -->
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav nav_1">
						...
						<li><a href="#search_products_range">Search for Products Based on Category name</a></li>
					</ul>
				 </div><!-- /.navbar-collapse -->
			</nav>
		</div>
...
<div id="search_products_range">
  ...
  $db="grocery";
   ...
   ?><form action="search_products_range.php" method="post">
	 <input type="text"   name="scatogery"/>
	   <input type="submit" name="submit" value="Search For products Based on category name"/>
 </form>
   <?php echo "</td>";
   echo "</tr>";
